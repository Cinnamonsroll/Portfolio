...
export function SectionCard({ title, children, dimmed }: SectionCardProps) {
  ...
  return (
    ...
    >
      <h2 className="text-[17px] md:text-[20px] leading-[1.2] italic text-accent tracking-tight font-medium transition-all duration-200 hover:opacity-80 hover:tracking-[0.02em]">
        {title}
      </h2>
